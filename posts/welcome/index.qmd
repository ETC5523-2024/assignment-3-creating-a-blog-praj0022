...
top_five <- tidy_data_2 |> 
            summarise("Religious spiritual activities" = mean(Religious_spiritual_activities, na.rm = TRUE), 
                       "Improved healthy lifestyle behaviors" = mean(Improved_healthy_lifestyle_behaviors, na.rm = TRUE), 
                       "Made a change to work situation" = mean(Made_a_change_to_work_situation, na.rm = TRUE), 
                       "Made a change to personal relationships" = mean(Made_a_change_to_personal_relationships, na.rm = TRUE), 
                       "Talked to friends or family" = mean(Talked_to_friends_or_family, na.rm = TRUE), 
                       "Took prescribed medication" = mean(Took_prescribed_medication, na.rm = TRUE),
                       "Spent time in nature" = mean(Spent_time_in_nature, na.rm = TRUE), 
                       "Talked to mental health professional" = mean(Talked_to_mental_health_professional, na.rm = TRUE))
